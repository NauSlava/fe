<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.subscriber.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://subscribers/" ) , 'title' => LocaleLoader::Translate( "vt.screens.subscriber.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://subscribers/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/subscribers/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://subscribers/}" class="back">&larr; {lang:vt.common.back}</a>
