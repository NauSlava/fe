<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.size.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://sizes/" ) , 'title' => LocaleLoader::Translate( "vt.screens.size.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://sizes/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/sizes/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://sizes/}" class="back">&larr; {lang:vt.common.back}</a>
