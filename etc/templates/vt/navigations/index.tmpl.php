<?php
    ...
    $grid = array(
        "columns" => array(
            ...
            , LocaleLoader::Translate( "vt.navigation.parentNavigationId" )
        ...
        , "colspans"	=> array()
        , "sorts"		=> array( 0 => "navigationType.title", 1 => "title", 2 => 'parentNavigation.title',  3 => "orderNumber",  4 => "url", 5 => "staticPage.title", 6 => "statusId")
        , "operations"	=> true
        , "allowAdd"	=> true
...
?>
			<tr data-object-id="{$id}">
                ...
                <td><?= $object->parentNavigationId ? $object->parentNavigation->title : ''?></td>
