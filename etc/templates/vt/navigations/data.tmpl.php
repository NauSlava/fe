<?php
    ...
    JsHelper::PushFile( 'js://vt/navigation.js' );
?>
<div class="tabs">
    ...
    <div id="page-0" class="tab-page rows">
        ...
        <div data-row="navigationTypeId" class="row required">
            ...
            <?= FormHelper::FormSelect( $prefix . '[navigationTypeId]', $navigationTypes, "navigationTypeId", "title", $object->navigationTypeId, null, null, true ); ?>
        </div>
        <div data-row="parentNavigationId" class="row">
            <label>{lang:vt.navigation.parentNavigationId}</label>
            <?= NavigationHelper::FormSelect( $prefix . '[parentNavigationId]', $navigations, $object->parentNavigationId, $object->navigationId, false ); ?>
        </div>
        ...
        <div data-row="staticPageId" class="row">
            ...
            <?= StaticPageHelper::FormSelect( $prefix . '[staticPageId]', $staticPages, $object->staticPageId, null, true ); ?>
        </div>
