<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.brand.list");

    $grid = array(
        "columns" => array(
           LocaleLoader::Translate( "vt.brand.title" )
            , LocaleLoader::Translate( "vt.brand.alias" )
            , LocaleLoader::Translate( "vt.brand.orderNumber" )
            , LocaleLoader::Translate( "vt.brand.statusId" )
        )
        , "colspans"	=> array()
        , "sorts"		=> array(0 => "title", 1 => "alias", 2 => "orderNumber", 3 => "statusId")
        , "operations"	=> true
        , "allowAdd"	=> true
        , "canPages"	=> BrandFactory::CanPages()
        , "basepath"	=> Site::GetWebPath( "vt://brands/" )
        , "addpath"		=> Site::GetWebPath( "vt://brands/add" )
        , "title"		=> $__pageTitle
		, "description"	=> ''
