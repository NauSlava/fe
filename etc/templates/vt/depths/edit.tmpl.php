<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.depth.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://depths/" ) , 'title' => LocaleLoader::Translate( "vt.screens.depth.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://depths/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/depths/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://depths/}" class="back">&larr; {lang:vt.common.back}</a>
