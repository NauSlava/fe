<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.templateItem.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://template-items/" ) , 'title' => LocaleLoader::Translate( "vt.screens.templateItem.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://template-items/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/template-items/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://template-items/}" class="back">&larr; {lang:vt.common.back}</a>
