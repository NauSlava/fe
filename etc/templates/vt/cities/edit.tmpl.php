<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.city.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://cities/" ) , 'title' => LocaleLoader::Translate( "vt.screens.city.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://cities/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/cities/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://cities/}" class="back">&larr; {lang:vt.common.back}</a>
