<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.formResult.editTitle") . ' №' . $object->formResultId;
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://forms/results/" ) , 'title' => LocaleLoader::Translate( "vt.screens.formResult.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://forms/results/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/forms/results/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://forms/results/}" class="back">&larr; {lang:vt.common.back}</a>
