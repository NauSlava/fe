<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.album.list");

    $grid = array(
        "columns" => array(
           LocaleLoader::Translate( "vt.album.title" )
            , LocaleLoader::Translate( "vt.album.alias" )
            , LocaleLoader::Translate( "vt.album.statusId" )
        )
        , "colspans"	=> array()
