<?php
	...
	$__breadcrumbs = array( 
		...
		, array( 'link' => Site::GetWebPath( "vt://products/categories/add" ) , 'title' => LocaleLoader::Translate( "vt.common.crumbAdd" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" id="data-form">
			...
			<div class="pagetitle"><h1>{$__pageTitle}</h1></div>
			...
			<div class="buttons">
				...
				<div class="buttons-inner"><?= FormHelper::FormSubmit( 'add', LocaleLoader::Translate( 'vt.common.saveChanges' ), null, 'large' ); ?></div>
			</div>
		</form>
	</div>
</div>
