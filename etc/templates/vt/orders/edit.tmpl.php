<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.order.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://orders/" ) , 'title' => LocaleLoader::Translate( "vt.screens.order.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://orders/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/orders/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://orders/}" class="back">&larr; {lang:vt.common.back}</a>
