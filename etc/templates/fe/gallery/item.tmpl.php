    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if( !empty( $albumItem->images )){ ?>
				...
				<a href="{web:vfs://}{$image.bigImage.path}" data-lightbox="gallery" data-title="{$albumItem.title}">
					<img src="/shared/files/{$image.smallImage.path}" alt="{$albumItem.title}" class="img-fluid">
