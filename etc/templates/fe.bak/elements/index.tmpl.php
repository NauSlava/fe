        ...
        <div class="flexslider">
            <ul class="slides">
                <li class="slide-<?= $menuClasses[0] ?>">
                    <img class="img-responsive" src="/shared/images/fe/slides/Plate.jpg">
					<div class="slide--title">Производство резиновой плитки</div>
                </li>
                <li class="slide-<?= $menuClasses[1] ?>">
                    <img class="img-responsive" src="/shared/images/fe/slides/Area.jpg">
					<div class="slide--title">Детские и спортивные площадки</div>
                </li>
                <li class="slide-<?= $menuClasses[2] ?>">
                    <img class="img-responsive" src="/shared/images/fe/slides/Grass.jpg">
					<div class="slide--title">Искусственная трава со склада</div>
                </li>
                <li class="slide-<?= $menuClasses[3] ?>">
                    <img class="img-responsive" src="/shared/images/fe/slides/Materials.jpg">
            ...
            <div class="column column1">
                <div class="productItem productItem-short">
                    ...
                    <div class="productItem--info">
                        <a class="productItem--title" href="<?= LinkUtility::GetProductItemUrl( $item );?>">{$item.title}</a>
                    ...
                    <div class='section-content'>
                        <div class='galleryItem'>
                            ...
                            <div class='galleryItem--photos'>
                                <div class='row row3'>
                                    <div class="column column1">
                                        <img class="img-responsive" src="/shared/images/fe/about/i1.jpg">
                                    </div>
                                    <div class="column column1">
                                        <img class="img-responsive" src="/shared/images/fe/about/i2.jpg">
                                    </div>
                                    <div class="column column1">
                                        <img class="img-responsive" src="/shared/images/fe/about/i3.jpg">
                                    </div>
                                </div>
